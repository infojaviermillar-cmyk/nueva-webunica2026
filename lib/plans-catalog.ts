...
export const SHOPIFY_PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '3 meses de garantía y soporte técnico prioritario post-lanzamiento',
    ],
  },
  {
    id: 'sh-full',
  ...
  },
  {
    ...
    highlight: 'Theme Propio & Optimización CRO',
    desc: 'Diseñado para maximizar ventas con theme propio optimizado para conversión, fichas de producto CRO avanzadas y hasta 300 productos.',
    price: 1200000,
    originalPrice: 1400000,
    ...
    features: [
      ...
      'Optimización de Ficha de Producto con mejoras CRO avanzadas',
      'Migración completa de hasta 300 productos con variantes',
      ...
      'Diseño de Landing Pages de aterrizaje personalizadas para campañas',
      'Consultoría estratégica individual de arquitectura e-commerce y CRO',
