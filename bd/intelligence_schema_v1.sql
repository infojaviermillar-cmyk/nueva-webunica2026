-- =====================================================================
-- WEBUNICA INTELLIGENCE v1 — Tablas completas
-- Usar TIMESTAMP WITH TIME ZONE (compatible con Supabase SQL Editor)
-- Ejecutar este archivo COMPLETO en un nuevo query
-- =====================================================================
