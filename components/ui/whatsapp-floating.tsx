  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className="relative bg-transparent hover:scale-105 transition-all duration-500 flex items-center gap-3 active:scale-95 cursor-pointer touch-manipulation pointer-events-auto"
        style={{ WebkitTapHighlightColor: 'transparent' }}
        aria-label="Contactar por WhatsApp"
      >
        <div className="relative w-14 h-14 rounded-full overflow-hidden shadow-2xl flex-shrink-0 pointer-events-none">
          <Image 
          ...
          />
          <div className="absolute bottom-1 right-1 w-3.5 h-3.5 bg-[#25d366] rounded-full border-2 border-white animate-pulse shadow-sm" />
        </div>
