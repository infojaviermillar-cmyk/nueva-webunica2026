      ...
      >
        ...
        <div className="flex-grow overflow-y-auto custom-scrollbar">
          ...
          <div className="bg-zinc-950 p-6 sm:py-6 sm:px-8 text-center relative overflow-hidden">
            ...
            <p className="text-zinc-300 text-xs sm:text-sm mt-1.5 font-light">Completa tus datos para iniciar la conversación con un asesor.</p>
          </div>

          <form onSubmit={handleSubmit} className="p-6 sm:px-8 sm:py-7 space-y-4">
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <select 
                  className="w-full bg-zinc-50/80 border border-zinc-300 rounded-2xl px-5 py-3.5 focus:outline-none focus:border-[#25d366] focus:ring-4 focus:ring-[#25d366]/15 transition-all text-zinc-950 font-semibold appearance-none cursor-pointer text-sm shadow-xs"
