        ...
        <div className="flex-grow overflow-y-auto custom-scrollbar">
          ...
          <div className="bg-zinc-950 p-10 text-center relative overflow-hidden">
            ...
            <div className="w-20 h-20 mx-auto mb-6 relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#25d366] to-emerald-400 rounded-full blur opacity-40 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
              <div className="relative w-20 h-20 bg-zinc-900 rounded-full flex items-center justify-center overflow-hidden border-2 border-white shadow-2xl">
                 <img 
              ...
              <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-[#25d366] rounded-full border-2 border-white flex items-center justify-center shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="p-8 sm:p-12 space-y-6">
            ...
            <div>
              <label className="block text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-2 ml-4">WhatsApp / Teléfono</label>
              <input 
                required
                type="tel" 
