...
export default function DisenoShopifyHeader() {
  ...
  return (
    <>
      ...
      {/* Menú Móvil */}
      <div className={`fixed inset-0 bg-white z-40 transition-transform duration-300 ${isMobileMenuOpen ? 'translate-y-0' : '-translate-y-full'} lg:hidden flex flex-col pt-32 px-6`}>
