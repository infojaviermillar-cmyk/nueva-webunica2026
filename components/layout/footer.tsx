          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mb-16">
            ...
            <div className="flex flex-col gap-6 col-span-2 md:col-span-3 lg:col-span-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://www.instagram.com/webunicachile/" target="_blank" rel="noreferrer" aria-label="Seguir a Webunica en Instagram" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:border-pink-500 transition-colors">
            ...
            <nav aria-labelledby="footer-resources-heading">
              <h3 id="footer-resources-heading" className="text-white font-semibold mb-6 uppercase tracking-wider text-xs">Recursos & Educación</h3>
              <ul className="space-y-4">
                <li>
            ...
            <address className="not-italic">
              <h3 className="text-white font-semibold mb-6 uppercase tracking-wider text-xs">Contacto</h3>
              <ul className="space-y-4">
                <li className="flex flex-col gap-4 text-zinc-400">
                  <div className="flex items-center gap-3">
                    <svg className="w-4 h-4 text-violet-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <EmailLink className="text-sm hover:text-white transition-colors" />
                  </div>
