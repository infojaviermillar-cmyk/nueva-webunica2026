          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className={`hidden md:flex items-center gap-2 px-7 py-3 rounded-full font-black text-[11px] uppercase tracking-[0.15em] transition-all transform animate-shake-20s shadow-[0_10px_30px_rgba(124,58,237,0.3)] bg-violet-600 text-white hover:bg-violet-700 hover:scale-105 active:scale-95`}
              >
