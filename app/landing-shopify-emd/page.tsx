          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-zinc-500 font-light mb-10">
                No usamos plantillas genéricas. Desarrollamos tiendas con <strong>diseños 100% personalizados</strong> que reflejan la identidad de tu marca, aplicando principios de CRO para transformar visitantes en compradores.
              </p>
